...
def predict():
    ...
    if request.method == 'POST':
        ...
        if prediction==0:
            return render_template('index2.html',prediction_texts="Sorry you are not eligible for loan")
        else:
            return render_template('index2.html',prediction_text="you are eligible for loan")
    else:
        return render_template('index2.html')
